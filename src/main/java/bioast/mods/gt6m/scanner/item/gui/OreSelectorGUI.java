...
public class OreSelectorGUI extends GuiScrollingList {
    ...
    public OreSelectorGUI(GuiScreen parent, int width, int height, int top, int bottom, int left, int entryHeight,
    ...
    protected void drawSlot(int slotIdx, int entryRight, int slotTop, int slotBuffer, Tessellator tess) {
        parent.drawString(parent.mc.fontRenderer ,parent.mc.fontRenderer.trimStringToWidth(keys.get(slotIdx),listWidth-10 ),this.left + 3, slotTop - 1, ores.getOrDefault(keys.get(slotIdx),0x7d7b76));
    }
}
